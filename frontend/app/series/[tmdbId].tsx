 ...
 */
export default function SeriesDetailScreen(): React.JSX.Element {
  ...
  const handleWatchlist = (): void => {
    if (series.is_in_watchlist && series.watchlist_id != null) {
      actions.removeFromWatchlist.mutate(series.watchlist_id);
    } else {
